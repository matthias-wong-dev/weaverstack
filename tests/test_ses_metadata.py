...
def test_identity_is_a_weaver_managed_bigint_column():
    """The Identity header names a Weaver surrogate column build adds as a
    not-null bigint — never engine-autogenerated — outside the business schema."""
    document = parse(
        "Table ID: Sales.Order\nDescription: x\nLineage: y\n"
